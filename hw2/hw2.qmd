...
print(data.frame(
  ...
  Memory_MB = c(size_base, size_readr, size_fread) / (1024^2)
))
```

\*\*Solution: The fastest function of reading a compressed csv file is fread.
...
![](images/clipboard-1269004251.png)
...
![](images/clipboard-3335862154.png)
...
![](images/clipboard-2930408836.png)
...
![](images/clipboard-1303198055.png)
...
![](images/clipboard-157299878.png)
