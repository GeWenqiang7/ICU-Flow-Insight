...
final_plot <- ggplot() +
  ...
  # Manual Adjustments
  scale_shape_manual(values = c(16, 17, 15)) +  # Different Shapes for Procedures
  scale_size_identity() +  
  scale_x_datetime(date_labels = "%b %d", date_breaks = "1 week") +  

  # Axis Labels and Themes
  labs(title =  paste("Patient", "and Procedure History"),
       x = "Calendar Time",
       y = "",
       color = "Care Unit",
       shape = "Procedure") +
  ...
  guides(color = guide_legend(nrow = 2), shape = guide_legend(nrow = 2))  # Split legend into two rows
